...
public class GifView extends RelativeLayout {
    ...
    public GifView setDrawableList(List<Drawable> drawableList) {
        this.drawableList = drawableList;
        return this;
    }

    public GifView setRiseDuration(int riseDuration) {
        this.riseDuration = riseDuration;
        return this;
    }

    public GifView setBottomPadding(int px) {
        this.bottomPadding = px;
        return this;
    }

    public GifView setOriginsOffset(int px) {
        this.originsOffset = px;
        return this;
    }

    public GifView setScaleAnimation(float maxScale, float minScale) {
        this.maxScale = maxScale;
        this.minScale = minScale;
        return this;
    }

    public GifView setAnimationDelay(int delay) {
    ...
    public GifView setItemViewWH(int viewWidth, int viewHeight) {
        this.viewHeight = viewHeight;
        this.viewWidth = viewWidth;
        return this;
    }

    public GifView setGiftBoxImaeg(Drawable drawable, int positionX, int positionY) {
